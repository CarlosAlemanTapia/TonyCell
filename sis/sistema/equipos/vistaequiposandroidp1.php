            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="box-title">Equipos Android "PUNTO 1"</h1>
                                <br>
                                <!-- MOdal -->
                                    ...
                                    <div class="modal-dialog modal-lg">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          ...
                                          <h2 class="modal-title">Agregar Equipos Android</h2>
                                        </div>
                                        <div class="modal-body">
                                          
                                            <form method="post" action="crearandroidp1.php">
...
<br>
                                        ...
                                        <?php
                                            ...
                                            $sentencia = $base_de_datos->query("SELECT * FROM equipos where status <> 'Entregado' and status <> 'No quedo' and marca <> 'Apple' and sucursal = 'Puesto 1' order by numero_nota desc ;");
